 ...
 *        We can use P0.4 and P0.5, If use as Coordinator then can not use UART2.
 * The P0.4 and P0.5 use for jumoer.
 */

#define JUMPERIN_BIT  BV(4)  //P0.4
#define JUMPERIN_SEL  P0SEL
#define JUMPERIN_DIR  P0DIR
#define JUMPERIN      P0

#define JUMPEROUT_BIT BV(5)  //P0.5
